...
setInterval(function () {
  var hasCompleted = audio.currentTime / audio.duration * 100; // console.log(hasCompleted);
    ...
    success: function success(data) {
      ...
      for (var i = 0; i < currentComments.hotComments.length; i++) {
        $.ajax({
          ...
          success: function success(data) {
            console.log(data); // currentComments.hotComments[i].commentId = data
          }
        });
      }
